...
function render(j){
  ...
  if(d){
    ...
    actions='<div class="card"><div class="done"><b>'+t('Připomínky jsme přijali.')+'</b><div class="muted" style="margin-top:6px">'+t('Konstrukce zapracovává úpravy — jakmile bude nová verze hotová, pošleme Vám ji ke schválení.')+'</div></div></div>';
  }else if(j.storno){
