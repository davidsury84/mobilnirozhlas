  ...
  async function apiTransition(req, res) {
    ...
    switch (action) {
      ...
      case 'odeslat-klientovi': { // obchodník odešle veřejný náhled (ručně, s možností upravit text)
        ...
        const lang = ['cs', 'en', 'de', 'pl', 'ua', 'ro'].includes(String(b.lang || '')) ? String(b.lang) : 'cs';
...
<script>
var NL={"Zadání zakázky bylo upraveno — výkres se přepracovává.": ["The order specification has been changed — the drawing is being reworked.", "Die Auftragsvorgaben wurden geändert — die Zeichnung wird überarbeitet.", "Specyfikacja zamówienia została zmieniona — rysunek jest przerabiany.", "Специфікацію замовлення змінено — креслення доопрацьовується.", "Specificația comenzii a fost modificată — desenul este refăcut."], "Náhled výkresu ke schválení": ["Drawing for approval", "Zeichnung zur Freigabe", "Rysunek do zatwierdzenia", "Креслення на затвердження", "Desen spre aprobare"], "Načítám…": ["Loading…", "Wird geladen…", "Wczytywanie…", "Завантаження…", "Se încarcă…"], "Odkaz není platný.": ["This link is not valid.", "Dieser Link ist ungültig.", "Link jest nieprawidłowy.", "Посилання недійсне.", "Linkul nu este valid."], "Nepodařilo se načíst náhled.": ["The preview could not be loaded.", "Die Vorschau konnte nicht geladen werden.", "Nie udało się wczytać podglądu.", "Не вдалося завантажити перегляд.", "Previzualizarea nu a putut fi încărcată."], "Nepodařilo se odeslat.": ["Sending failed.", "Senden fehlgeschlagen.", "Nie udało się wysłać.", "Не вдалося надіслати.", "Trimiterea a eșuat."], "Tento náhled je chráněn PINem, který jste dostali zvlášť.": ["This preview is protected by a PIN you received separately.", "Diese Vorschau ist durch eine separat zugesandte PIN geschützt.", "Ten podgląd jest chroniony PIN-em przesłanym osobno.", "Цей перегляд захищено PIN-кодом, який ви отримали окремо.", "Această previzualizare este protejată printr-un PIN primit separat."], "Pokračovat": ["Continue", "Weiter", "Dalej", "Продовжити", "Continuă"], "PDF výkresu není k dispozici.": ["The drawing PDF is not available.", "Das Zeichnungs-PDF ist nicht verfügbar.", "PDF rysunku jest niedostępny.", "PDF креслення недоступний.", "PDF-ul desenului nu este disponibil."], "Výkres": ["Drawing", "Zeichnung", "Rysunek", "Креслення", "Desen"], "Zákazník:": ["Customer:", "Kunde:", "Klient:", "Замовник:", "Client:"], "Verze:": ["Version:", "Version:", "Wersja:", "Версія:", "Versiune:"], "NÁHLED": ["PREVIEW", "VORSCHAU", "PODGLĄD", "ПЕРЕГЛЯД", "PREVIZUALIZARE"], "Prohlédněte si výkres a zvolte, jak chcete pokračovat:": ["Review the drawing and choose how to proceed:", "Prüfen Sie die Zeichnung und wählen Sie, wie es weitergehen soll:", "Sprawdź rysunek i wybierz, jak chcesz kontynuować:", "Перегляньте креслення та оберіть, як продовжити:", "Verificați desenul și alegeți cum doriți să continuați:"], "✓ Schválit": ["✓ Approve", "✓ Freigeben", "✓ Zatwierdź", "✓ Затвердити", "✓ Aprobă"], "✎ Poslat připomínky": ["✎ Send comments", "✎ Anmerkungen senden", "✎ Wyślij uwagi", "✎ Надіслати зауваження", "✎ Trimite observații"], "✕ Zamítnout": ["✕ Reject", "✕ Ablehnen", "✕ Odrzuć", "✕ Відхилити", "✕ Respinge"], "Rozhodujete jako": ["You are deciding as", "Sie entscheiden als", "Decydujesz jako", "Ви вирішуєте як", "Decideți ca"], "rozhoduje někdo jiný?": ["someone else deciding?", "entscheidet jemand anderes?", "decyduje ktoś inny?", "вирішує хтось інший?", "decide altcineva?"], "Vaše jméno": ["Your name", "Ihr Name", "Twoje imię i nazwisko", "Ваше імʼя", "Numele dumneavoastră"], "Jméno a příjmení": ["First and last name", "Vor- und Nachname", "Imię i nazwisko", "Імʼя та прізвище", "Nume și prenume"], "Potvrzuji, že výkres odpovídá objednávce a schvaluji jej k výrobě.": ["I confirm the drawing matches the order and approve it for production.", "Ich bestätige, dass die Zeichnung der Bestellung entspricht, und gebe sie für die Fertigung frei.", "Potwierdzam, że rysunek jest zgodny z zamówieniem i zatwierdzam go do produkcji.", "Підтверджую, що креслення відповідає замовленню, і затверджую його у виробництво.", "Confirm că desenul corespunde comenzii și îl aprob pentru producție."], "Schválit výkres": ["Approve the drawing", "Zeichnung freigeben", "Zatwierdź rysunek", "Затвердити креслення", "Aprobă desenul"], "Připomínky k výkresu": ["Comments on the drawing", "Anmerkungen zur Zeichnung", "Uwagi do rysunku", "Зауваження до креслення", "Observații la desen"], "Popište, co je třeba upravit…": ["Describe what needs to change…", "Beschreiben Sie, was geändert werden soll…", "Opisz, co należy poprawić…", "Опишіть, що потрібно змінити…", "Descrieți ce trebuie modificat…"], "Odeslat připomínky": ["Send comments", "Anmerkungen senden", "Wyślij uwagi", "Надіслати зауваження", "Trimite observațiile"], "Důvod zamítnutí": ["Reason for rejection", "Grund der Ablehnung", "Powód odrzucenia", "Причина відхилення", "Motivul respingerii"], "Uveďte prosím důvod…": ["Please state the reason…", "Bitte geben Sie den Grund an…", "Podaj proszę powód…", "Вкажіть, будь ласка, причину…", "Vă rugăm să indicați motivul…"], "Zamítnout výkres": ["Reject the drawing", "Zeichnung ablehnen", "Odrzuć rysunek", "Відхилити креслення", "Respinge desenul"], "✓ Výkres byl schválen a předán do výroby.": ["✓ The drawing has been approved and released to production.", "✓ Die Zeichnung wurde freigegeben und in die Fertigung übergeben.", "✓ Rysunek został zatwierdzony i przekazany do produkcji.", "✓ Креслення затверджено та передано у виробництво.", "✓ Desenul a fost aprobat și trimis în producție."], "Odkaz zůstává platný — výkres si tu můžete kdykoli znovu prohlédnout.": ["The link stays valid — you can view the drawing here at any time.", "Der Link bleibt gültig — Sie können die Zeichnung hier jederzeit ansehen.", "Link pozostaje ważny — rysunek możesz tu obejrzeć w każdej chwili.", "Посилання залишається дійсним — креслення можна переглянути тут будь-коли.", "Linkul rămâne valabil — puteți vedea desenul aici oricând."], "✕ Výkres byl zamítnut.": ["✕ The drawing has been rejected.", "✕ Die Zeichnung wurde abgelehnt.", "✕ Rysunek został odrzucony.", "✕ Креслення відхилено.", "✕ Desenul a fost respins."], "Ozve se Vám náš obchodník.": ["Our sales representative will contact you.", "Unser Vertriebsmitarbeiter meldet sich bei Ihnen.", "Skontaktuje się z Tobą nasz handlowiec.", "З вами звʼяжеться наш менеджер.", "Agentul nostru de vânzări vă va contacta."], "Připomínky jsme přijali.": ["We have received your comments.", "Wir haben Ihre Anmerkungen erhalten.", "Otrzymaliśmy Twoje uwagi.", "Ми отримали ваші зауваження.", "Am primit observațiile dumneavoastră."], "Konstrukce zapracovává úpravy — jakmile bude nová verze hotová, pošleme Vám ji ke schválení.": ["Engineering is making the changes — we will send you the new version for approval as soon as it is ready.", "Die Konstruktion arbeitet die Änderungen ein — sobald die neue Version fertig ist, senden wir sie Ihnen zur Freigabe.", "Konstrukcja wprowadza zmiany — gdy nowa wersja będzie gotowa, prześlemy ją do zatwierdzenia.", "Конструкторський відділ вносить зміни — щойно нова версія буде готова, надішлемо її на затвердження.", "Proiectarea implementează modificările — vă vom trimite noua versiune spre aprobare imediat ce este gata."], "Zakázka byla stornována.": ["The order has been cancelled.", "Der Auftrag wurde storniert.", "Zlecenie zostało anulowane.", "Замовлення скасовано.", "Comanda a fost anulată."], "V případě dotazu se prosím obraťte na svého obchodníka.": ["If you have any questions, please contact your sales representative.", "Bei Fragen wenden Sie sich bitte an Ihren Vertriebsmitarbeiter.", "W razie pytań skontaktuj się ze swoim handlowcem.", "У разі запитань звертайтеся до свого менеджера.", "Pentru întrebări, contactați agentul dumneavoastră de vânzări."], "Zabezpečený náhled · dokument slouží jen ke schválení, nešiřte prosím odkaz dál.": ["Secure preview · the document is for approval only, please do not share the link.", "Geschützte Vorschau · das Dokument dient nur der Freigabe, bitte teilen Sie den Link nicht.", "Zabezpieczony podgląd · dokument służy wyłącznie do zatwierdzenia, prosimy nie udostępniać linku.", "Захищений перегляд · документ призначений лише для затвердження, не поширюйте посилання.", "Previzualizare securizată · documentul servește doar aprobării, vă rugăm să nu distribuiți linkul."], "Komunikace": ["Messages", "Kommunikation", "Komunikacja", "Листування", "Comunicare"], "Klient": ["Customer", "Kunde", "Klient", "Замовник", "Client"], "ACTS — železniční abroll kontejner": ["ACTS — rail hook-lift container", "ACTS — Abrollcontainer für die Bahn", "ACTS — kolejowy kontener hakowy", "ACTS — залізничний гаковий контейнер", "ACTS — container feroviar cu cârlig"], "AFO — kontejnery pro f. Hamo (skandinávský typ)": ["AFO — containers for Hamo (Scandinavian type)", "AFO — Container für Fa. Hamo (skandinavischer Typ)", "AFO — kontenery dla f. Hamo (typ skandynawski)", "AFO — контейнери для ф. Hamo (скандинавський тип)", "AFO — containere pentru Hamo (tip scandinav)"], "AFS — kontejnery v normě AFNOR": ["AFS — containers to AFNOR standard", "AFS — Container nach AFNOR", "AFS — kontenery wg normy AFNOR", "AFS — контейнери за нормою AFNOR", "AFS — containere conform AFNOR"], "ALST — provedení Alustahl (vybraní zákazníci)": ["ALST — Alustahl design (selected customers)", "ALST — Ausführung Alustahl (ausgewählte Kunden)", "ALST — wykonanie Alustahl (wybrani klienci)", "ALST — виконання Alustahl (окремі замовники)", "ALST — execuție Alustahl (clienți selectați)"], "ARC — kontejner na sklo": ["ARC — glass container", "ARC — Glascontainer", "ARC — kontener na szkło", "ARC — контейнер для скла", "ARC — container pentru sticlă"], "BS — provedení s podélnými prolisy (Veolia France)": ["BS — design with longitudinal beads (Veolia France)", "BS — Ausführung mit Längssicken (Veolia France)", "BS — wykonanie z przetłoczeniami wzdłużnymi (Veolia France)", "BS — виконання з поздовжніми зигами (Veolia France)", "BS — execuție cu nervuri longitudinale (Veolia France)"], "CITY — uzavřený městský kontejner (hákový)": ["CITY — enclosed municipal container (hook-lift)", "CITY — geschlossener Stadtcontainer (Abroll)", "CITY — zamknięty kontener miejski (hakowy)", "CITY — закритий міський контейнер (гаковий)", "CITY — container municipal închis (cu cârlig)"], "DSD — kontejnery v normě DIN (DIN 30722)": ["DSD — containers to DIN standard (DIN 30722)", "DSD — Container nach DIN (DIN 30722)", "DSD — kontenery wg normy DIN (DIN 30722)", "DSD — контейнери за нормою DIN (DIN 30722)", "DSD — containere conform DIN (DIN 30722)"], "ECL — kulaté bezvýztuhové provedení (pipe shape)": ["ECL — round stiffener-free design (pipe shape)", "ECL — runde versteifungsfreie Ausführung (Pipe Shape)", "ECL — okrągłe wykonanie bez wzmocnień (pipe shape)", "ECL — кругле виконання без ребер (pipe shape)", "ECL — execuție rotundă fără rigidizări (pipe shape)"], "HBI — Hardox velké vypouklé (BIG & strong)": ["HBI — Hardox large convex (BIG & strong)", "HBI — Hardox groß gewölbt (BIG & strong)", "HBI — Hardox duże wypukłe (BIG & strong)", "HBI — Hardox великі опуклі (BIG & strong)", "HBI — Hardox mari bombate (BIG & strong)"], "HBS — Hardox „halbšálen\\" (půlkulaté provedení)": ["HBS — Hardox half-shell (semi-round design)", "HBS — Hardox Halbschalen (halbrunde Ausführung)", "HBS — Hardox półskorupowe (wykonanie półokrągłe)", "HBS — Hardox напівкругле виконання", "HBS — Hardox semirotund (execuție semicirculară)"], "LWC — lehké provedení Hardox / Strenx 700": ["LWC — lightweight Hardox / Strenx 700 design", "LWC — Leichtausführung Hardox / Strenx 700", "LWC — wykonanie lekkie Hardox / Strenx 700", "LWC — легке виконання Hardox / Strenx 700", "LWC — execuție ușoară Hardox / Strenx 700"], "MULDA — skip / Absetzmulde (řetězová ramena)": ["MULDA — skip / Absetzmulde (chain arms)", "MULDE — Absetzmulde (Kettenarme)", "MULDA — kontener KP / Absetzmulde (ramiona łańcuchowe)", "MULDA — скіп / Absetzmulde (ланцюгові рамена)", "MULDA — benă / Absetzmulde (brațe cu lanț)"], "NL — kontejnery pro holandský trh (Dutch type)": ["NL — containers for the Dutch market (Dutch type)", "NL — Container für den niederländischen Markt (Dutch type)", "NL — kontenery na rynek holenderski (Dutch type)", "NL — контейнери для нідерландського ринку (Dutch type)", "NL — containere pentru piața olandeză (Dutch type)"], "PAL — plato s alu bočnicemi": ["PAL — flatbed with aluminium sides", "PAL — Plattform mit Alu-Seitenwänden", "PAL — platforma z burtami aluminiowymi", "PAL — платформа з алюмінієвими бортами", "PAL — platformă cu obloane din aluminiu"], "PAP — abroll s otvory na papír": ["PAP — hook-lift with paper openings", "PAP — Abrollcontainer mit Papieröffnungen", "PAP — hakowy z otworami na papier", "PAP — гаковий з отворами для паперу", "PAP — cu cârlig cu orificii pentru hârtie"], "PDK — plato, dřevěná podlaha, s klanicemi": ["PDK — flatbed, wooden floor, with stakes", "PDK — Plattform, Holzboden, mit Rungen", "PDK — platforma, podłoga drewniana, z kłonicami", "PDK — платформа, дерев’яна підлога, зі стійками", "PDK — platformă, podea din lemn, cu țepuși"], "POP — abroll s víky (Hausmüll)": ["POP — hook-lift with lids (Hausmüll)", "POP — Abrollcontainer mit Deckeln (Hausmüll)", "POP — hakowy z pokrywami (Hausmüll)", "POP — гаковий з кришками (Hausmüll)", "POP — cu cârlig cu capace (Hausmüll)"], "PS — plato standard, ocelová podlaha": ["PS — standard flatbed, steel floor", "PS — Plattform Standard, Stahlboden", "PS — platforma standard, podłoga stalowa", "PS — платформа стандарт, сталева підлога", "PS — platformă standard, podea din oțel"], "PSK — plato, ocelová podlaha, s klanicemi": ["PSK — flatbed, steel floor, with stakes", "PSK — Plattform, Stahlboden, mit Rungen", "PSK — platforma, podłoga stalowa, z kłonicami", "PSK — платформа, сталева підлога, зі стійками", "PSK — platformă, podea din oțel, cu țepuși"], "PSN — plato se zadním nájezdem": ["PSN — flatbed with rear ramp", "PSN — Plattform mit Auffahrt hinten", "PSN — platforma z najazdem tylnym", "PSN — платформа із заднім заїздом", "PSN — platformă cu rampă spate"], "PSNK — plato se zadním nájezdem a klanicemi": ["PSNK — flatbed with rear ramp and stakes", "PSNK — Plattform mit Auffahrt hinten und Rungen", "PSNK — platforma z najazdem tylnym i kłonicami", "PSNK — платформа із заднім заїздом і стійками", "PSNK — platformă cu rampă spate și țepuși"], "PT — plato těžké provedení s prohlubní": ["PT — heavy-duty flatbed with recess", "PT — Plattform Schwerausführung mit Vertiefung", "PT — platforma ciężka z zagłębieniem", "PT — платформа важкого виконання із заглибленням", "PT — platformă grea cu adâncitură"], "RAM — rám ABR (frames)": ["RAM — ABR frame (frames)", "RAM — ABR-Rahmen (Frames)", "RAM — rama ABR (frames)", "RAM — рама ABR (frames)", "RAM — cadru ABR (frames)"], "SLD — kontejner na separovaný sběr": ["SLD — separate collection container", "SLD — Container für Getrenntsammlung", "SLD — kontener do zbiórki selektywnej", "SLD — контейнер для роздільного збору", "SLD — container pentru colectare selectivă"], "STH — stohovací kontejnery dle DIN": ["STH — stackable containers to DIN", "STH — stapelbare Container nach DIN", "STH — kontenery sztaplowane wg DIN", "STH — контейнери, що штабелюються, за DIN", "STH — containere stivuibile conform DIN"], "SU — kontejner na separovaný sběr": ["SU — separate collection container", "SU — Container für Getrenntsammlung", "SU — kontener do zbiórki selektywnej", "SU — контейнер для роздільного збору", "SU — container pentru colectare selectivă"], "USB / LSB — skladovací stohovací box": ["USB / LSB — stackable storage box", "USB / LSB — stapelbare Lagerbox", "USB / LSB — skrzynia magazynowa sztaplowana", "USB / LSB — складський бокс, що штабелюється", "USB / LSB — cutie de depozitare stivuibilă"], "WD — bezvýztuhové kontejnery v normě DIN": ["WD — stiffener-free containers to DIN", "WD — versteifungsfreie Container nach DIN", "WD — kontenery bez wzmocnień wg DIN", "WD — контейнери без ребер за DIN", "WD — containere fără rigidizări conform DIN"], "WF — bezvýztuhové kontejnery v normě AFNOR": ["WF — stiffener-free containers to AFNOR", "WF — versteifungsfreie Container nach AFNOR", "WF — kontenery bez wzmocnień wg AFNOR", "WF — контейнери без ребер за AFNOR", "WF — containere fără rigidizări conform AFNOR"], "HDC — Hardox korby tvaru U (typ à la GTS)": ["HDC — Hardox U-shaped bodies (GTS type)", "HDC — Hardox U-Mulden (Typ GTS)", "HDC — skrzynie Hardox w kształcie U (typ GTS)", "HDC — кузови Hardox U-подібні (тип GTS)", "HDC — bene Hardox in forma de U (tip GTS)"], "TH — thermokontejner": ["TH — thermo container", "TH — Thermocontainer", "TH — kontener termiczny", "TH — термоконтейнер", "TH — container termic"]};
var LANG='cs', LIDX={en:0,de:1,pl:2,ua:3,ro:4};
...
function render(j){
  ...
  var head='<div class="card"><h1>'+t('Výkres')+' '+esc(j.cislo)+'</h1><div class="muted">'+esc(t(j.typName||''))+'</div>'+
