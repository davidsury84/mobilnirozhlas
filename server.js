  ...
  sekce: [
    ...
    { id: 'H', nazev: 'Celkové hodnocení a novinky', jen: 'vsichni', otazky: [
      ...
      { id: 'q26', typ: 'vice', text: 'Které z následujících novinek nebo služeb byste na shop.elkoplast.cz uvítal/a?', moznosti: [
        ...
        { k: 'i', t: '✉️ odběr novinek a akčních nabídek e-mailem' }], jine: true },
      { id: 'q27', typ: 'vice', text: 'Připravujeme rozšíření sortimentu. O které z těchto produktů byste měl/a zájem?', pozn: 'Označte vše, co by se vám hodilo.', moznosti: [
        { k: 'f', t: '🌺 velké designové květináče a truhlíky' },
        { k: 'a', t: '🪑 městský mobiliář — lavičky, odpadkové koše' },
        { k: 'n', t: '☀️ solární a chytrý mobiliář (lavičky s nabíjením, chytré koše)' },
        { k: 'r', t: '🗄️ regálové systémy a vybavení skladu' },
        { k: 'q', t: '🧖 wellness — sauny a vířivky' },
        { k: 's', t: '🌿 kompostéry (včetně elektrických kuchyňských)' },
        { k: 't', t: '🏠 zahradní domky, dřevníky a přístřešky' },
        { k: 'g', t: '💧 designové nádrže na dešťovou vodu' },
        { k: 'h', t: '⛲ čerpadla na vodu a zavlažování' },
        { k: 'i', t: '🤖 úklidové roboty (zametací a mycí)' },
        { k: 'j', t: '🌱 robotické sekačky na velké plochy' },
        { k: 'l', t: '❄️ zimní údržba — posypová technika, radlice, nářadí' },
        { k: 'o', t: '🔌 nabíjecí stanice a vybavení pro elektromobilitu' },
        { k: 'p', t: '🏋️ venkovní fitness a herní prvky' },
        { k: 'u', t: '🎄 vánoční osvětlení a výzdoba pro obce a firmy' }], jine: true },
...
try {
  nakupReportMod = require('./nakup-report').mount({ reportDisabled,
    send, readBody, deliver, isAdmin, isAdminEmp, empSession, employeeModules, getState,
    dataDir: DATA_DIR,
